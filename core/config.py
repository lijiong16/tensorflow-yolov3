...
__C.TRAIN.ANNOT_PATH            = "./data/dataset/colab_train.txt"
...
__C.TRAIN.INITIAL_WEIGHT        = "/content/drive/My Drive/yolov3_test_loss=13.0953.ckpt-3"#"./checkpoint/yolov3_coco_demo.ckpt"#'dont use'#
...
__C.TEST.ANNOT_PATH             = "./data/dataset/colab_test.txt"
